...
class UserCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_comment" do
    assert_difference('UserComment.count') do
      post user_comments_url, params: { user_comment: { comment_validation: @user_comment.comment_validation, content: @user_comment.content, user_id: @user_comment.user_id } }
    end
  ...
  test "should update user_comment" do
    patch user_comment_url(@user_comment), params: { user_comment: { comment_validation: @user_comment.comment_validation, content: @user_comment.content, user_id: @user_comment.user_id } }
